...
F_variables = ["section_moment_capacity", "compression_area", "compression_force", "moment_demand"]
        ...
        for b in b_list
            for d in d_list
                for comp_ratio in  compression_ratio_list
                    ...
                    section_moment_capacity = fy * total_rebar_area * (d - d * comp_ratio / 2)
                    ...
                    # Append row
                    push!(df, (
                        section_moment_capacity, compression_area, compression_force, section_moment_capacity,
